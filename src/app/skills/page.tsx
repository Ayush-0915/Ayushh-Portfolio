                ...
                <div className="max-w-7xl mx-auto relative z-10 w-full mt-12 md:mt-16">
                    <div className="relative w-full flex flex-col justify-center items-center mb-0">
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-6xl font-medium tracking-tight text-foreground uppercase">
                                THE AI ENGINEERING STACK
                            </h2>
                            <p className="text-sm md:text-base text-muted-foreground leading-relaxed pt-2">
                                A carefully selected technology stack powering intelligent systems, machine learning models, modern web applications, and scalable AI products.
                            </p>
                        </motion.div>
                    </div>
