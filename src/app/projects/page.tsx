                ...
                <div className="relative z-10 flex items-center gap-4 sm:gap-8 py-6 sm:py-10 px-4 sm:px-8">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-3 mb-2">
                            ...
                            <span className={cn(
                                "shrink-0 px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider",
                                isOngoing
                                ...
                                {project.category || (isOngoing ? 'ongoing' : 'done')}
                            </span>
                            ...
                            <div className="flex items-center gap-2">
                                {project.repoUrl && project.repoUrl !== '#' && (
                                    <a
                                        ...
                                        className="p-1 rounded bg-black/10 dark:bg-white/5 hover:bg-black/20 dark:hover:bg-white/10 text-muted-foreground hover:text-foreground transition-colors border border-black/5 dark:border-white/5 flex items-center justify-center"
                        ...
                        {/* Subtle Technology Badge Row */}
                        <div className="flex flex-wrap gap-1.5 mt-3">
                            {project.techStack.slice(0, 6).map((tech) => {
                                const Icon = Icons[getIconKey(tech)];
                                return (
                                    <div key={tech} className="flex items-center gap-1 px-2.5 py-1 rounded-full border border-foreground/5 dark:border-white/5 text-[10px] font-medium text-foreground/50 bg-transparent transition-colors group-hover:border-foreground/10 dark:group-hover:border-white/10 hover:bg-black/5 dark:hover:bg-white/5">
                                        {Icon ? <Icon className="w-3 h-3" /> : <div className="w-1 h-1 rounded-full bg-foreground/20" />}
                                        {tech}
                                    </div>
                                );
                            })}
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            {project.repoUrl && project.repoUrl !== '#' && (
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                    onClick={(e) => e.stopPropagation()}
                                    className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-neutral-100 dark:hover:bg-zinc-800 transition-colors"
                                    title="GitHub Repository"
                                >
