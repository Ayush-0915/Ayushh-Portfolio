  ...
  return (
    <div className="w-full bg-background font-sans" ref={containerRef}>
      <div className="relative max-w-7xl mx-auto pb-20">
        ...
        {/* Timeline Vertical Track Line (styled purely via CSS to prevent rendering/layout loops) */}
        <div
          className="absolute left-[19px] md:left-[159px] top-[24px] bottom-[80px] w-[2px] bg-neutral-200 dark:bg-neutral-800/80 pointer-events-none rounded-full"
        >
        ...
        {/* Observed container (contains only items and no absolute heights, preventing loops) */}
