...
const GITHUB_USER = "Ayush-0915";

const PINNED_REPOS = [
  {
    name: "Nexus-AI",
    desc: "State-of-the-art cognitive desktop assistant and personal AI operating system with voice intelligence, screen perception, and local RAG.",
    stars: 12,
    forks: 4,
    lang: "Python",
    url: "https://github.com/Ayush-0915/Nexus-AI"
  },
  {
    name: "CareerNova",
    desc: "AI Resume Analyzer, career roadmap generator, and mock interview assistant built with Next.js, FastAPI, and Gemini API.",
    stars: 10,
    forks: 2,
    lang: "TypeScript",
    url: "https://github.com/Ayush-0915/CareerNova"
  },
  {
    name: "CreditWise",
    desc: "Machine learning loan default prediction and risk assessment dashboard using stacked ensemble classifiers and SHAP explanations.",
    stars: 8,
    forks: 3,
    lang: "Python",
    url: "https://github.com/Ayush-0915/CreditWise"
  },
  {
    name: "Netflix-Data-Analysis",
    desc: "Exploratory Data Analysis and content mapping system processing movie and TV show catalogs with TF-IDF recommendations.",
    stars: 6,
    forks: 1,
    lang: "Python",
    url: "https://github.com/Ayush-0915/Netflix-Data-Analysis"
  },
  {
    name: "Uber-Trips-Analysis",
    desc: "Dynamic spatial analytics and traffic density modeling analyzing ride logs to identify demand patterns and vehicle hubs.",
    stars: 7,
    forks: 2,
    lang: "Python",
