                    ...
                    >
                        ...
                        <div className="hidden lg:flex items-center gap-6">
                            ...
                            <Link
                                ...
                                className="relative px-5 py-2 text-sm font-bold transition-all duration-300 rounded-full group border border-primary/20 hover:border-primary/50 bg-primary/5 hover:bg-primary/10 text-foreground"
                            >
                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            >
                                <Link href="https://github.com/Ayush-0915/Ayushh-Portfolio" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="relative flex flex-col items-center justify-center h-full overflow-y-auto py-20">
                                <nav className="flex flex-col items-center gap-6">
                                    ...
                                    <Link
                                        ...
                                        rel="noopener noreferrer"
                                        onClick={closeMenu}
                                        className="text-3xl font-black text-muted-foreground hover:text-foreground transition-colors border border-primary/10 px-6 py-1.5 rounded-full bg-primary/5"
                                    >
                                        Resume
                                    </Link>
