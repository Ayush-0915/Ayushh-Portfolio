      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              HI, I'M AYUSH SINGH. I BUILD INTELLIGENT AI SYSTEMS, MACHINE LEARNING APPLICATIONS, AND DATA-DRIVEN SOLUTIONS.
            </motion.p>
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              OPEN TO AI ENGINEERING, ML RESEARCH, FREELANCE PROJECTS, AND COLLABORATIONS WORLDWIDE.
            </motion.p>
          </div>
        </div>
            ...
            {showProfile && (
              ...
              >
                <ProfileCard
                  ...
                  description={`${personal.name} is a B.Tech student in Artificial Intelligence and Machine Learning from Sage University, focused on deep learning, computer vision, data science, and generative AI. He designs and builds intelligent systems, machine learning applications, and robust data-driven solutions.`}
