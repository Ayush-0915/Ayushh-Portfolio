...
const NODES_DATA: Record<string, NodeData[]> = {
    ...
    journey: [
        ...
        { label: 'Space Portfolio', description: 'Immersive WebGL/Three.js 3D space interactive experience.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=400&auto=format&fit=crop" },
