...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Sage University', description: 'B.Tech in Artificial Intelligence & Machine Learning (CGPA 7.0).', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=400&auto=format&fit=crop" },
        { label: 'High School', description: 'Science & Mathematics Foundation with focus on logic and analysis.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=400&auto=format&fit=crop" },
        { label: 'Azure Fundamentals', description: 'Microsoft Azure Fundamentals (AZ-900) Certification.', orbitIndex: 0, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop" },
        { label: 'Oracle Cloud AI', description: 'OCI AI Foundations Associate Certification.', orbitIndex: 1, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=400&auto=format&fit=crop" },
        { label: 'Red Hat OpenShift', description: 'Enterprise Container Orchestration & App Deployment.', orbitIndex: 0, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=400&auto=format&fit=crop" },
        { label: 'AI/ML Projects', description: 'Hands-on development of deep learning models and RAG applications.', orbitIndex: 1, position: 0.05, imageUrl: "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=400&auto=format&fit=crop" },
    ],
    journey: [
        { label: 'GitHub Projects', description: 'Building and publishing open source ML/AI and developer utilities.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=400&auto=format&fit=crop" },
        { label: 'CareerNova AI', description: 'Launching personal SaaS resume analysis platform using LLMs.', orbitIndex: 1, position: 0.35, imageUrl: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=400&auto=format&fit=crop" },
        { label: 'Car Evaluation', description: 'Automating vehicle evaluation using Decision Tree and Random Forest classifiers.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=400&auto=format&fit=crop" },
        { label: 'CreditWise Risk', description: 'Analyzing financial risk factors and default patterns with ML.', orbitIndex: 1, position: 0.75, imageUrl: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=400&auto=format&fit=crop" },
        { label: 'Netflix Data EDA', description: 'Analyzing catalog metadata, mapping releases, and content filters.', orbitIndex: 0, position: 0.9, imageUrl: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=400&auto=format&fit=crop" },
        { label: 'Uber Spatial EDA', description: 'Clustering passenger coordinate hot spots with DBSCAN.', orbitIndex: 1, position: 0.02, imageUrl: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=400&auto=format&fit=crop" },
    ],
    experience: [
        { label: 'AI Architect', description: 'Nexus AI - Designing secure speech and visual desktop RAG systems.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?q=80&w=400&auto=format&fit=crop" },
        { label: 'ML Engineer', description: 'CreditWise - Tuning stacked random forest and XGBoost default models.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1454165833911-5421db635848?q=80&w=400&auto=format&fit=crop" },
        { label: 'Open Source Contrib', description: 'Publishing ML templates and utility scripts on GitHub.', orbitIndex: 0, position: 0.6, imageUrl: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=2000&auto=format&fit=crop" },
        { label: 'Lead Creator', description: 'CareerNova - Building FastAPI resume analyzers and mock interview bots.', orbitIndex: 1, position: 0.8, imageUrl: "https://images.unsplash.com/photo-1518433278988-c7bc488ce92d?q=80&w=400&auto=format&fit=crop" },
        { label: 'AI Researcher', description: 'Exploratory spatial clustering and catalog analytics modeling.', orbitIndex: 0, position: 0.95, imageUrl: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=400&auto=format&fit=crop" },
        { label: 'Deep Learning', description: 'Implementing convolutional feature maps and model pipelines.', orbitIndex: 1, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop" },
    ]
};
            ...
            <div className="w-full mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-12 items-center h-full overflow-visible">
                ...
                <div className="relative z-20 space-y-8 lg:-ml-28 lg:pr-12">
                    ...
                    >
                        ...
                        <div className="pt-4">
                            <Link
                                href="/resume/Ayush_Singh_Resume.pdf"
                                target="_blank"
